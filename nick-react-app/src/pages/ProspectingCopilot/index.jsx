...
const ProspectingCopilot = () => {
  ...
  const handleGptResponse = async () => {
    ...
    console.log("Data: ", data.prompts[0]?.response?.emails);
  ...
  return (
    ...
    <div className='flex-col flex w-[85vw] pt-48 gap-8 items-center overflow-scroll justify-end'>
      <div className='flex-col items-center flex justify-center'>
        ...
        <div
          style={{ boxShadow: 'rgba(0, 0, 0, 0.15) 0px -50px 20px -40px inset' }}
      ...
      <div className='w-[40vw] mt-6 mb-6'>
        <div className='flex items-start mb-6 font-bold'>{questionNumber <= 2 ? questions[questionNumber] : ''}</div>
