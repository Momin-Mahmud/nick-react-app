  ...
  <div className="mt-20 w-[30vw] mx-auto">
    <div className="space-y-6" action="#" method="POST">
      <div>
        ...
        <div className="mt-2">
      <input placeholder="Enter your email" id="email" name="email" type="email" autoComplete="email" required className="block w-full text-sm rounded-md border-[1px] border-[#E5E7EB] py-1.5 px-2 shadow-sm  placeholder:text-gray-400 focus:outline-none bg-white"/>
      ...
      <div>
        ...
        <div className="mt-2">
      <input placeholder="**********" id="password" name="password" type="password" autoComplete="email" required className="block w-full text-sm rounded-md border-[1px] border-[#E5E7EB] py-1.5 px-2 shadow-sm  placeholder:text-gray-400 focus:outline-none bg-white"/>
        </div>
        <div className="text-sm flex items-start">
            <a href="#" className="text-[#6B7280] font-light mt-1 hover:text-indigo-500">Forgot password?</a>
          </div>
      </div>
      <div>
