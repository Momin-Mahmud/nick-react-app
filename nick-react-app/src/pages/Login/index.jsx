    ...
    <div className='flex min-h-full justify-center items-center h-[80vh]'>
      ...
      <div className='bg-[#F3F4F6] flex items-center justify-center h-[80vh]'>
        <div className='flex flex-col bg-[#F3F4F6] items-center justify-center w-[50vw] px-24 mt-[32vh] mx-auto'>
          ...
          <div className='z-10'>
            <img className='z-20' src={loginImage} height={1000} width={1000} />
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              <div>
                ...
                <div className='text-sm flex items-center justify-center'>
                  <a href='#' className='text-[#6B7280] font-light mt-4 hover:text-indigo-500'>
                    No account yet?
                    <span className='px-1 text-[#A21CAF]'>Create an account</span>
                  </a>
                </div>
              ...
              <div className='text-left mt-6'>
                <div>
                  By signing up to the SalesCoPilots platform you understand and agree to our 
                  <span className='text-[#A21CAF] underline px-1'>Terms and Conditions</span> and <span className='text-[#A21CAF] underline px-1'>Privacy Policy.</span> This site is protected by Google
                  reCAPTCHA to ensure you’re not a bot.
                </div>
                <div className='text-left mt-4 text-sm text-[#9CA3AF]'>
                  Need help? Contact us at <span className='text-[#A21CAF] underline px-1'>
