    ...
    <div className="w-full bg-white p-16 justify-start items-start rounded-lg flex flex-col gap-6">
      ...
      <div className="flex flex-col items-start w-[70%] justify-start">
        ...
        <div className="w-full relative">
          ...
          <select
            ref={selectRef}
            className="h-10 w-full bg-white text-slate-700 text-sm border border-slate-200 rounded px-3 py-2 mb-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-400 shadow-sm focus:shadow-md appearance-none"
            value={formData.role}
